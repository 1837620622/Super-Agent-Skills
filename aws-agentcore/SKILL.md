---
name: aws-agentcore
description: "使用 AWS Bedrock AgentCore 构建 AI 代理。适用于在 AWS 基础设施上开发代理、创建工具使用模式、实现代理编排或与 Bedrock 模型集成。触发关键词：AgentCore, Bedrock Agent, AWS agent, Lambda tools, AWS AI 代理。"
---
