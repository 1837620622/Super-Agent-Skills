---
name: aws-strands
description: "使用 Strands Agents SDK 构建 AI 代理。适用于开发模型无关代理、实现 ReAct 模式、创建多代理系统或在 AWS 上构建生产级代理。触发关键词：Strands, Strands SDK, model-agnostic agent, ReAct agent, Strands 代理。"
---
