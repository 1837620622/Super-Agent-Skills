---
name: fal-ai
description: "使用 fal.ai 无服务器 AI 生成图像、视频和音频。适用于构建 AI 图像生成、视频生成、图像编辑或实时 AI 功能。触发关键词：fal.ai, fal, AI image generation, Flux, SDXL, real-time AI, serverless AI, AI 图像生成。"
---
