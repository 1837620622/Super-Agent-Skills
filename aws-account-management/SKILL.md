...
description: "管理 AWS 账户、组织、IAM 和计费。适用于设置 AWS Organizations、管理 IAM 策略、控制成本或实施多账户策略。触发关键词：AWS Organizations, AWS IAM, AWS billing, Cost Explorer, SCPs, multi-account, AWS SSO, Identity Center, AWS 账户管理。"
---

# AWS 账户管理

使用最佳实践管理 AWS 账户、组织和身份。
